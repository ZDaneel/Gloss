...
-- Started on 2024-09-09 14:55:32 CST
...
COPY public.chats (id, chat_id, history_id, question, content, paragraphs, temperature, past_questions, past_answers, error_message, is_good, created_at) FROM stdin;
\.


--
-- TOC entry 3607 (class 0 OID 16439)
-- Dependencies: 215
-- Data for Name: history; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.history (id, paper_title, created_at) FROM stdin;
\.


--
-- TOC entry 3608 (class 0 OID 16446)
-- Dependencies: 216
-- Data for Name: resources; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.resources (id, history_id, is_file, resource_name, created_at) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.resources_id_seq', 77, true);


--
-- TOC entry 3460 (class 2606 OID 16468)
...
--
-- TOC entry 3456 (class 2606 OID 16445)
...
--
-- TOC entry 3458 (class 2606 OID 16453)
...
--
-- TOC entry 3461 (class 2606 OID 16497)
...
--
-- TOC entry 3606 (class 0 OID 16462)
-- Dependencies: 217
...
-- Completed on 2024-09-09 14:55:32 CST
